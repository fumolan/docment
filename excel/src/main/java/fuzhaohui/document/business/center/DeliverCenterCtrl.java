...
//                }
                if("A".equals(deliverBaseVO.getModel())
                        || "C".equals(deliverBaseVO.getModel())
                               || "E".equals(deliverBaseVO.getModel())){
                    distributionRulePO.setDistributionProduct("0");
                }else if("B".equals(deliverBaseVO.getModel())
                        || "D".equals(deliverBaseVO.getModel())){
                    distributionRulePO.setDistributionProduct("0,1,2");
                }
